  ...
  function handle($match, $state, $pos, &$handler) {
    ...
    case DOKU_LEXER_MATCHED:
      ...
      case 'manual':
        ...
        if(getNS($value) != "") /* Absolute Path */ $this->refManUrl = wl($value);
        else {
          //Relative Path
          global $ID;
        ...
        break;
      case 'support':$this->supportUrl = $value; break;
      case 'image':$this->primaryImage = $value; break;
    ...
    case DOKU_LEXER_EXIT :
      ...
      if($this->title != '') {
        ...
        if($this->subtitle) $infoboxTpl->setVariable("SUBTITLE", $this->subtitle);
        $infoboxTpl->setVariable("TITLE", $this->title);
